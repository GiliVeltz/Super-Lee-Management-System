...
public class DiscountSuppliersPerProduct extends DiscountSuppliers {
    ...
    public DiscountSuppliersPerProduct(boolean percentageDiscount , double amount , double discount , int Id ){
        super(amount , discount, Id);
        this.percentageDiscount = percentageDiscount;

    }
    public DiscountSuppliersPerProduct(DiscountSupplierDTO discountSupplierDTO) {
